...
function SettingItem({ 
  ...
  return (
    <Animated.View style={pressStyle}>
      <Pressable
        className={cn(
          "bg-white rounded-xl p-4 mb-3 flex-row items-center",
          disabled && "opacity-50"
        )}
        onPress={handlePress}
      ...
      <ScrollView className="flex-1 px-4 py-4" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-4">
          ...
          <Text className="text-sm text-blue-800 leading-relaxed">
            This implementation uses Apple's Core ML framework with advanced features like stateful models, INT4 quantization, and Apple Neural Engine acceleration. The Phi-4-mini model is specifically optimized for mathematical reasoning tasks with 3.8B parameters and 128K context length.
          </Text>
        </View>
        ...
        <View className="bg-gray-100 rounded-xl p-4">
          ...
          <Text className="text-xs text-gray-500 text-center mt-1">
            On-Device AI • Privacy-First • Offline Capable
          </Text>
        </View>
      </ScrollView>
    </View>
